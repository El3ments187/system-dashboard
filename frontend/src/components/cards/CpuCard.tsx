      ...
      <div className="metric-card">
        ...
        <div className="card-details">
          <div
            ...
            onMouseEnter={(e) => {
              const desc = getMetricDescription("cpu_temperature");
              if (desc)
          ...
          <div
            className="card-detail-item"
            onMouseEnter={(e) => {
              const desc = getMetricDescription("cpu_frequency");
              if (desc)
                tooltip.setCardTooltip(
                  {
                    title: desc.title,
          ...
          <div
            className="card-detail-item"
            onMouseEnter={(e) => {
              const desc = getMetricDescription("cpu_cores");
              if (desc)
                tooltip.setCardTooltip(
                  {
                    title: desc.title,
          ...
          <div
            className="card-detail-item"
            onMouseEnter={(e) => {
              const desc = getMetricDescription("cpu_threads");
              if (desc)
                tooltip.setCardTooltip(
                  {
                    title: desc.title,
          ...
          <div
            ...
            onMouseEnter={(e) => {
              const desc = getMetricDescription("cpu_load_1m");
              if (desc)
                tooltip.setCardTooltip(
                  {
                    title: `${desc.title} / ${getMetricDescription("cpu_load_5m")?.title ?? ""} / ${getMetricDescription("cpu_load_15m")?.title ?? ""}`,
                    description: desc.description,
                    direction: desc.direction,
                  },
                  e,
