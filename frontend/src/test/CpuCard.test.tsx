        ...
        <TooltipProvider>
          <MetricsContext.MetricsContext.Provider
            value={mockMetricsContext({
              cpuCurrentValues: [45, null, 3800, 8, 16, 2.5, 2.1, 1.8],
            })}
          >
    ...
    it("shows Warning status when utilization >= 70%", () => {
      const { container } = render(
        <TooltipProvider>
          <MetricsContext.MetricsContext.Provider
            value={mockMetricsContext({
              cpuCurrentValues: [75, 65, 3800, 8, 16, 2.5, 2.1, 1.8],
            })}
          >
            <CpuCard accent={accent} />
          </MetricsContext.MetricsContext.Provider>
    ...
    it("shows Critical status when utilization >= 90%", () => {
      const { container } = render(
        <TooltipProvider>
          <MetricsContext.MetricsContext.Provider
            value={mockMetricsContext({
              cpuCurrentValues: [95, 65, 3800, 8, 16, 2.5, 2.1, 1.8],
            })}
          >
            <CpuCard accent={accent} />
          </MetricsContext.MetricsContext.Provider>
  ...
  describe("loading state", () => {
    it("shows skeleton loader when loading", () => {
      render(
        <TooltipProvider>
          <MetricsContext.MetricsContext.Provider
            value={mockMetricsContext({ cpuLoading: true })}
          >
            <CpuCard accent={accent} />
          </MetricsContext.MetricsContext.Provider>
        </TooltipProvider>,
  ...
  describe("error state", () => {
    it("shows error UI when cpuError is set", () => {
      render(
        <TooltipProvider>
          <MetricsContext.MetricsContext.Provider
            value={mockMetricsContext({ cpuError: "Connection failed" })}
          >
            <CpuCard accent={accent} />
          </MetricsContext.MetricsContext.Provider>
        </TooltipProvider>,
    ...
    it("shows fallback for null CPU utilization", () => {
      render(
        <TooltipProvider>
          <MetricsContext.MetricsContext.Provider
            value={mockMetricsContext({
              cpuCurrentValues: [null, 65, 3800, 8, 16, 2.5, 2.1, 1.8],
            })}
          >
            <CpuCard accent={accent} />
          </MetricsContext.MetricsContext.Provider>
    ...
    it("shows fallback for all null values", () => {
      render(
        <TooltipProvider>
          <MetricsContext.MetricsContext.Provider
            value={mockMetricsContext({
              cpuCurrentValues: [null, null, null, 0, 0, null, null, null],
            })}
          >
            <CpuCard accent={accent} />
          </MetricsContext.MetricsContext.Provider>
    ...
    it("shows zero cores as fallback", () => {
      render(
        <TooltipProvider>
          <MetricsContext.MetricsContext.Provider
            value={mockMetricsContext({
              cpuCurrentValues: [45, 65, 3800, 0, 16, 2.5, 2.1, 1.8],
            })}
          >
            <CpuCard accent={accent} />
          </MetricsContext.MetricsContext.Provider>
    ...
    it("shows correct temperature with Turquoise accent", () => {
      render(
        <TooltipProvider>
          <MetricsContext.MetricsContext.Provider
            value={mockMetricsContext({
              cpuCurrentValues: [45, 85, 3800, 8, 16, 2.5, 2.1, 1.8],
            })}
          >
            <CpuCard accent={turquoiseAccent} />
          </MetricsContext.MetricsContext.Provider>
    ...
    it("handles high utilization with Turquoise accent", () => {
      const { container } = render(
        <TooltipProvider>
          <MetricsContext.MetricsContext.Provider
            value={mockMetricsContext({
              cpuCurrentValues: [92, 85, 3800, 8, 16, 2.5, 2.1, 1.8],
            })}
          >
            <CpuCard accent={turquoiseAccent} />
          </MetricsContext.MetricsContext.Provider>
    ...
    it("renders progress bar with normal state for low utilization", () => {
      const { container } = render(
        <TooltipProvider>
          <MetricsContext.MetricsContext.Provider
            value={mockMetricsContext({
              cpuCurrentValues: [30, 65, 3800, 8, 16, 2.5, 2.1, 1.8],
            })}
          >
            <CpuCard accent={turquoiseAccent} />
          </MetricsContext.MetricsContext.Provider>
