...
export const metricDescriptions: Record<string, MetricDescription> = {
  ...
  'cpu_temperature': {
    ...
    description: 'Current CPU core temperature. Higher values indicate more thermal load',
    unit: '°C',
    direction: 'lower-is-better',
  },
  'cpu_frequency': {
  ...
  'cpu_load_1m': {
    ...
    description: 'Average system load over the last 1 minute. Compare against core count for context',
    unit: '',
    direction: 'lower-is-better',
  },
  'cpu_load_5m': {
  ...
  'swap_used_gb': {
    title: 'Swap Used',
    description: 'Amount of disk-based swap space currently in use. High values may indicate memory pressure',
    unit: 'GB',
    direction: 'lower-is-better',
  },
  'swap_total_gb': {
  ...
  'gpu_temperature': {
    ...
    description: 'Current GPU core temperature. Higher values indicate more thermal load',
    unit: '°C',
    direction: 'lower-is-better',
  },
  'gpu_vram_used_gb': {
